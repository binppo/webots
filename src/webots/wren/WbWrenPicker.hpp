...
public:
  ...
  enum {
	  HANDLES_X_AXIS = 0x7FFFFFF1,
	  HANDLES_Y_AXIS = 0x7FFFFFF2,
	  HANDLES_Z_AXIS = 0x7FFFFFF3,
	  HANDLES_TRANSLATE = 0x7FFFFFF0,
	  HANDLES_ROTATE = 0x7FFFFFF4,
	  HANDLES_SCALE = 0x7FFFFFF8,
