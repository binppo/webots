...
namespace WbFileUtil {
  ...
  WB_LIB_EXPORT bool copyAndReplaceString(const QString &sourcePath, const QString &destinationPath, QList<QPair<QString, QString>> values);
  ...
  WB_LIB_EXPORT bool isLocatedInInstallationDirectory(const QString &file);
  ...
  WB_LIB_EXPORT const QString &extension(FileType);
